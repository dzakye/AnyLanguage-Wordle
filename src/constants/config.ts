export const CONFIG = {
  ...
  startDate: 'November 9, 2023 00:00:00', // what date and time to start your game from
  defaultLang: 'arp', // the default interface language
  availableLangs: ['arp','f','en', 'es', 'sw', 'zh'], // the options available to the user for translation languages
